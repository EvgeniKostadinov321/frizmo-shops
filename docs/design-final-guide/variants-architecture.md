...
## Инвентар: ИМПЛЕМЕНТИРАНИТЕ варианти (2026-07-05, всички ✅ освен trust badges)
...
| Trust badges ⏭ | ред икони | (идея: hairline лента) | (идея: 2×2 карти) |
...
Announcement няма варианти (utility лента). Общо: **30 композиции**. Всички са
...
- ✅ **Всички секции** (без trust badges): папка+dispatcher за големите

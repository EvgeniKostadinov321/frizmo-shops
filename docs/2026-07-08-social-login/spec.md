...
> ⚠️ **ЗАМЕНЕН (2026-07-12):** каноничният спец вече е
> `docs/superpowers/specs/2026-07-12-social-login-design.md` (ревизиран с решения:
> само Google първа итерация, проектиран за търговци + купувачи, callback error handling,
> open-redirect гард). Този файл се пази само като исторически запис.

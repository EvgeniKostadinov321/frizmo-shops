...
> **ТЕСТ ФАЗА (2026-07-11):** влизаме в ръчна проверка едно по едно. Пълен чек-лист →
> **`docs/testing-checklist.md`**. 6 pure-code функции + конверсионно трио са на прод;
> „Доверие + AOV" пакетът (#7) е готов локално, НЕ push-нат.

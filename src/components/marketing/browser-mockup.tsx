  ...
  return (
    ...
    >
      ...
      <div className="p-4">
        ...
        <div className="mt-4 rounded-control bg-gradient-to-br from-brand-600 to-brand-700 p-5">
        ...
        <div className="mt-4 grid grid-cols-3 gap-3">
          {["🧀", "🍯", "🥚"].map((emoji, i) => (
            <div key={i} className="rounded-control border border-surface-200 p-2">
              <div className="flex aspect-square items-center justify-center rounded bg-surface-50 text-3xl">
                {emoji}
              </div>

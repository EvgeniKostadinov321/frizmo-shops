...
const SELLER_PROOFS = [
  "Безплатен старт, без месечна такса",
  "Готов магазин за минути",
  "Плащаш само при реална продажба",
];
...
export function AuthForm({ mode, action, oauthError, role, next }: AuthFormProps) {
  ...
  const panelSubtitle = isBuyer
    ...
    : "Собствен онлайн магазин, направен за българския търговец — без хаос, без месечна такса, без технически главоболия.";

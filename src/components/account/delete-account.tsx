    ...
    <div className="flex flex-col gap-3 rounded-card border border-danger-600/30 bg-surface-0 p-4">
      <div>
        ...
        <p className="mt-1 text-sm text-ink-500">
          Профилът и любимите ти се изтриват. Данните в вече направени поръчки (име, адрес за
          доставка) се пазят от съответните търговци за счетоводни и данъчни цели, както изисква
          законът. Напиши „ИЗТРИЙ“ за потвърждение.
        </p>
      </div>
      <Input
        label="Потвърждение"
